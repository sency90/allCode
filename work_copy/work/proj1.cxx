...
//Input Files: ./suspicious.txt, ./malicious.txt
//Output File: ./output_proj1.txt
...
int main() {
    ...
    FILE *fw = fopen("./output_proj1.txt", "w");
    auto println = [l,fw](const string& s, int idx, ll val) {
        for(int i=0; i<l; i++) fprintf(fw, "%c", s[idx+i]);
        fprintf(fw, " %lld\n", val);
    };
    ...
    printf("'./output_proj1.txt' has been made successfully!!\n");
    return 0;
}
