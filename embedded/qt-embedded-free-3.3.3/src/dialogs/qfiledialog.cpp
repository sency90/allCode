/****************************************************************************
** $Id: qt/qfiledialog.cpp   3.3.3   edited Jul 12 18:39 $
**
...
#elif defined(Q_WS_MAC)
    if( qt_use_native_dialogs && ( qApp->style().inherits(QMAC_DEFAULT_STYLE) || qApp->style().inherits("QMacStyle") ) )
	return macGetSaveFileName( initialSelection, filter, workingDirectory, parent, name, caption, selectedFilter );
#endif
					   ...
					   bool resolveSymlinks)
{
    ...
    if( qt_use_native_dialogs && ( qApp->style().inherits(QMAC_DEFAULT_STYLE) || qApp->style().inherits("QMacStyle") ) )
	return macGetOpenFileNames("", initialDir, parent, name, caption, 0, FALSE, TRUE).first();
#endif
